...
def addPeopleInfo(request):
    ...
    if models.oldperson_info.objects.filter(idcard=idcard).exists():
        return {'msg': '用户信息已经存在，请查看信息是否填写有误，或者选择更新信息', "code": '205'}
    ...
    try:
        ...
        return {'msg': '服务器错误，请重试', "code": '500'}
    globeFunction.write_info_to_csv("F:/SummerVacation2023/intelligent-pension-system/caresystem/views/info/people_info.csv", face.ID, json_data["oldname"], "old_people")
