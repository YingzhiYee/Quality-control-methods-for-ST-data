...
def addEmployInfo(request):
    ...
    globeFunction.write_info_to_csv("F:/SummerVacation2023/intelligent-pension-system/caresystem/views/info/people_info.csv",face.ID,json_data["employeename"],"employee")
