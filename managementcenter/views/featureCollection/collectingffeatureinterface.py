...
from managementcenter.views.featureCollection.facial import FaceUtil
...
imagedir = 'managementcenter/views/featureCollection/featureInfo/images'
# global variable
dataset_path = 'managementcenter/views/featureCollection/featureInfo/images'
output_encoding_file_path = 'managementcenter/views/models/face_recognition_hog.pickle'
image_paths = list(paths.list_images(dataset_path))
output_file = 'managementcenter/views/featureCollection/voices/output.mp3'
