...
def addVolunteerInfo(request):
    ...
    try:
        ...
        return {'msg': '服务器错误，请重试', "code": '500'}
    globeFunction.write_info_to_csv("F:/SummerVacation2023/intelligent-pension-system/caresystem/views/info/people_info.csv", face.ID, json_data["volunteername"], "volunteer")
